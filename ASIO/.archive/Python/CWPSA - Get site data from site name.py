    ...
    if response and response.status_code == 200:
        ...
        if detail_response and detail_response.status_code == 200:
            ...
            address = {
                ...
                "SiteFriendlyName": friendly_name,
                "ResolvedSiteName": friendly_name if friendly_name else site.get("name", ""),
                "AddressLine1": site_data.get("addressLine1", ""),
                "AddressLine2": site_data.get("addressLine2", ""),
                "City": site_data.get("city", ""),
                "State": site_data.get("stateReference", {}).get("identifier", ""),
                "PostalCode": site_data.get("zip", ""),
                "Country": site_data.get("country", {}).get("name", "")
            }
...
def main():
    try:
        try:
            ticket_number = input.get_value("TicketNumber_1749602175801")
            site_name = input.get_value("SiteName_1749602174572")
        except Exception:
