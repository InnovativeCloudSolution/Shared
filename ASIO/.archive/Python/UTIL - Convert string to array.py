...
def main():
    try:
        try:
            raw_string = input.get_value("StringToConvert_1749843343721")
            delimiter1 = input.get_value("Delimiter1_1749982245232")
            delimiter2 = input.get_value("Delimiter2_1749982246898")
            delimiter3 = input.get_value("Delimiter3_1749982248322")
            delimiter4 = input.get_value("Delimiter4_1749982250560")
        except Exception:
