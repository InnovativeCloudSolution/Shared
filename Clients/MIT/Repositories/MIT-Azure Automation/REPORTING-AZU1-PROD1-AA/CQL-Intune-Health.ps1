...
function Initialize {
    ...
    $Global:TenantUrl = 'cleancoqueensland.onmicrosoft.com'
    $Global:ClientIdSecretName = "MIT-PartnerAppClientID"
    $Global:ClientSecretSecretName = "MIT-Partner-App-Client-Secret"
    try {
    ...
    $Global:ClientIdentifier = "CQL"
    $Global:ContactName = "ICT Operations"
    $Global:ServiceBoardName = "CQL-HelpDesk (MS)"
