...
Mangano IT - Exchange Online - Assign User Rights for Shared Mailbox
...
if ($null -ne $Mailbox) {
    try {
        ...
        Add-MailboxPermission $SharedMailbox -User $EmailAddress -AccessRights $AccessRights -InheritanceType all | Out-Null
