...
function Initialize {
    ...
    $Global:sourceDnNumber = "7002"  # Template user for BLFs
    $Global:dnPropertyName = "SHARED_BLFS"  # DN Property to update
    $Global:3CXURL = "https://voip.manganoit.com.au:5001"
    $Global:Secret3CX = "MIT-3CX-7000"  # Azure Key Vault secret name for 3CX user #7000's password
    try {
...
function GetExcludedNumbers {
    ...
    $excludedNumbers = @(
        9000, 9028, 9050, 9064, 9066, 9077, 9088, 9099
    )
